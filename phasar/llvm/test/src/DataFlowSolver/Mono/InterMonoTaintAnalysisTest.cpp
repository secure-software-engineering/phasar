...
TEST_F(InterMonoTaintAnalysisTest, TaintTest_03) {
  std::set<std::string> Facts{"20", "21", "22",     "24",    "27",
                              "28", "32", "main.0", "main.1"};
  doAnalysisAndCompare("taint_11.ll", 34, Facts);
}

TEST_F(InterMonoTaintAnalysisTest, TaintTest_03_v2) {
  auto Leaks = doAnalysis("taint_11.ll");
  // 35 => {34}
...
TEST_F(InterMonoTaintAnalysisTest, TaintTest_05) {
  ...
  "main.1"}; doAnalysisAndCompare("taint_13.ll", 31, Facts);
}
...
//   auto Leaks = doAnalysis("taint_9.ll");
//   // 14 => {13}
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[14] = {"13"};
//   compareResults(Leaks, GroundTruth);
...
//   auto Leaks = doAnalysis("taint_10.ll");
//   // 20 => {19}
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[20] = {"19"};
//   compareResults(Leaks, GroundTruth);
...
//   auto Leaks = doAnalysis("taint_12.ll");
//   // 36 => {35}
...
//   auto Leaks = doAnalysis("taint_13.ll");
//   // 32 => {31}
...
//   auto Leaks = doAnalysis("taint_4_v2.ll");
//   // 19 => {18}
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[19] = {"18"};
...
//   auto Leaks = doAnalysis("taint_2_v2.ll");
//   // 10 => {9}
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[10] = {"9"};
//   compareResults(Leaks, GroundTruth);
...
//   auto Leaks = doAnalysis("taint_2_v2_1.ll");
//   // 4 => {3}
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[4] = {"3"};
//   compareResults(Leaks, GroundTruth);
...
//   auto Leaks = doAnalysis("source_sink_function_test.ll");
//   // 41 => {40};
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[41] = {"40"};
//   compareResults(Leaks, GroundTruth);
...
//   auto Leaks = doAnalysis("taint_14.ll");
...
//   auto Leaks = doAnalysis("taint_14_1.ll");
...
//   auto Leaks = doAnalysis("taint_15.ll");
//   // 21 => {20}
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[21] = {"20"};
...
//   auto Leaks = doAnalysis("taint_15_1.ll");
//   // 16 => {15};
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[16] = {"15"};
...
//   auto Leaks = doAnalysis("virtual_calls.ll");
//   // 20 => {19};
//   std::map<int, std::set<std::string>> GroundTruth;
...
//   auto Leaks = doAnalysis("virtual_calls_v2.ll");
//   // 7 => {6};
//   std::map<int, std::set<std::string>> GroundTruth;
...
//   auto Leaks = doAnalysis("struct_member.ll");
//   // 16 => {15};
//   // 19 => {18};
//   std::map<int, std::set<std::string>> GroundTruth;
...
//   auto Leaks = doAnalysis("dynamic_memory.ll");
//   // 11 => {10}
//   std::map<int, std::set<std::string>> GroundTruth;
//   GroundTruth[11] = {"10"};
//   compareResults(Leaks, GroundTruth);
...
//   auto Leaks = doAnalysis("dynamic_memory_simple.ll");
//   // 15 => {14}
//   std::map<int, std::set<std::string>> GroundTruth;
