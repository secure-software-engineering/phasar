...
using namespace psr;
namespace psr {
  TEST(LTHTest, GraphConstruction) {
    ProjectIRDB IRDB(
      {"../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_1.ll",
       "../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_7.ll",
       "../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_8.ll",
       "../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_9.ll",
       "../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_10.ll"});
    llvm::Module *M = IRDB.getModule("../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_1.ll");
    ...
    M = IRDB.getModule("../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_7.ll");
    //Creates an empty type hierarchy
    ...
    M = IRDB.getModule("../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_8.ll");
    //Creates an empty type hierarchy
    ...
    M = IRDB.getModule("../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_9.ll");
    //Creates an empty type hierarchy
    ...
    M = IRDB.getModule("../../../../test/llvm_test_code/type_hierarchies/type_hierarchy_10.ll");
    //Creates an empty type hierarchy
  ...
  TEST(LTHTest, VTableConstruction) {
    ...
    ASSERT_TRUE(cxx_demangle(TH5.getVTableEntry("Base", 0)) == "__cxa_pure_virtual");
  ...
  TEST(LTHTest, TransitivelyReachableTypes) {
    ...
    auto reachable_types_nonvirtualclass_3 = TH3.getTransitivelyReachableTypes("NonvirtualClass");
    auto reachable_types_nonvirtualstruct_3 = TH3.getTransitivelyReachableTypes("NonvirtualStruct");
    ...
    // Will be way less dangerous to have an interface (like a map) between the llvm
    // given name of class & struct (i.e. struct.Base.base ...) and the name inside
    // phasar (i.e. just Base) and never work with the llvm name inside phasar
    ...
    ASSERT_TRUE(reachable_types_nonvirtualstruct_3.count("struct.NonvirtualStruct"));
