...
protected:
  ...
  void Initialize(const std::vector<std::string> &IRFiles) {
    ...
    constproblem = new IFDSConstAnalysis(
        IRDB, TH, ICFG, PT, EntryPoints);
  }
  ...
  compareResults(const std::set<unsigned long> &groundTruth,
                 IFDSSolver<IFDSConstAnalysis::n_t,IFDSConstAnalysis::d_t,IFDSConstAnalysis::m_t,IFDSConstAnalysis::t_t,IFDSConstAnalysis::v_t,IFDSConstAnalysis::i_t> &solver) {
...
TEST_F(IFDSConstAnalysisTest, HandleBasicTest_01) {
  ...
  IFDSSolver<IFDSConstAnalysis::n_t,IFDSConstAnalysis::d_t,IFDSConstAnalysis::m_t,IFDSConstAnalysis::t_t,IFDSConstAnalysis::v_t,IFDSConstAnalysis::i_t> llvmconstsolver(
      *constproblem);
