...
protected:
  ...
  void initialize(const std::vector<std::string> &IRFiles) {
    ...
    SecureHeapPropagationProblem =
      make_unique<IDESecureHeapPropagation>(IRDB, TH,
                                            ICFG, PT,
                                            EntryPoints);
    SecureHeapPropagationResults =
    ...
    Desc = make_unique<OpenSSLSecureHeapDescription>(*SecureHeapPropagationResults);
    TSProblem = make_unique<IDETypeStateAnalysis>(IRDB, TH,
                                                  ICFG, PT,
                                                  *Desc, EntryPoints);
