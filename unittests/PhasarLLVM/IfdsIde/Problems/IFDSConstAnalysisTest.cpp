...
TEST_F(IFDSConstAnalysisTest, HandleBasicTest_01) {
  Initialize({pathToLLFiles + "basic/basic_01_cpp.ll"});
...
TEST_F(IFDSConstAnalysisTest, HandleBasicTest_02) {
  Initialize({pathToLLFiles + "basic/basic_02_cpp.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
...
TEST_F(IFDSConstAnalysisTest, HandleBasicTest_03) {
  Initialize({pathToLLFiles + "basic/basic_03_cpp.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleBasicTest_04) {
  Initialize({pathToLLFiles + "basic/basic_04_cpp.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCFForTest_01) {
  Initialize({pathToLLFiles + "control_flow/cf_for_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
...
TEST_F(IFDSConstAnalysisTest, HandleCFForTest_02) {
  Initialize({pathToLLFiles + "control_flow/cf_for_02_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCFIfTest_01) {
  Initialize({pathToLLFiles + "control_flow/cf_if_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCFIfTest_02) {
  Initialize({pathToLLFiles + "control_flow/cf_if_02_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCFWhileTest_01) {
  Initialize({pathToLLFiles + "control_flow/cf_while_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({0}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandlePointerTest_01) {
  Initialize({pathToLLFiles + "pointer/pointer_01_cpp.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandlePointerTest_02) {
  Initialize({pathToLLFiles + "pointer/pointer_02_cpp.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, DISABLED_HandlePointerTest_03) {
  ...
  // information
  Initialize({pathToLLFiles + "pointer/pointer_03_cpp.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
...
TEST_F(IFDSConstAnalysisTest, HandlePointerTest_04) {
  Initialize({pathToLLFiles + "pointer/pointer_04_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
...
TEST_F(IFDSConstAnalysisTest, HandleGlobalTest_01) {
  Initialize({pathToLLFiles + "global/global_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({0}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleGlobalTest_02) {
  Initialize({pathToLLFiles + "global/global_02_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
...
TEST_F(IFDSConstAnalysisTest, HandleGlobalTest_03) {
  Initialize({pathToLLFiles + "global/global_03_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({0}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, DISABLED_HandleGlobalTest_04) {
  // Guaranteed to fail - enable, once we have more precise points-to
  // information
  Initialize({pathToLLFiles + "global/global_04_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
...
TEST_F(IFDSConstAnalysisTest, HandleCallParamTest_01) {
  Initialize({pathToLLFiles + "call/param/call_param_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
...
TEST_F(IFDSConstAnalysisTest, HandleCallParamTest_02) {
  Initialize({pathToLLFiles + "call/param/call_param_02_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({4}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCallParamTest_03) {
  Initialize({pathToLLFiles + "call/param/call_param_03_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, DISABLED_HandleCallParamTest_04) {
  // Guaranteed to fail - enable, once we have more precise points-to
  // information
  Initialize({pathToLLFiles + "call/param/call_param_04_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, DISABLED_HandleCallParamTest_05) {
  // Guaranteed to fail - enable, once we have more precise points-to
  // information
  Initialize({pathToLLFiles + "call/param/call_param_05_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
...
TEST_F(IFDSConstAnalysisTest, HandleCallParamTest_06) {
  Initialize({pathToLLFiles + "call/param/call_param_06_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCallParamTest_07) {
  Initialize({pathToLLFiles + "call/param/call_param_07_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({4}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCallParamTest_08) {
  Initialize({pathToLLFiles + "call/param/call_param_08_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({3}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCallReturnTest_01) {
  Initialize({pathToLLFiles + "call/return/call_ret_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCallReturnTest_02) {
  Initialize({pathToLLFiles + "call/return/call_ret_02_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({0}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCallReturnTest_03) {
  Initialize({pathToLLFiles + "call/return/call_ret_03_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({0}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleArrayTest_01) {
  Initialize({pathToLLFiles + "array/array_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleArrayTest_02) {
  Initialize({pathToLLFiles + "array/array_02_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleArrayTest_03) {
  Initialize({pathToLLFiles + "array/array_03_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, DISABLED_HandleArrayTest_04) {
  // Guaranteed to fail - enable, once we have more precise points-to
  // information
  Initialize({pathToLLFiles + "array/array_04_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleArrayTest_05) {
  Initialize({pathToLLFiles + "array/array_05_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleArrayTest_06) {
  Initialize({pathToLLFiles + "array/array_06_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, DISABLED_HandleArrayTest_07) {
  // Guaranteed to fail - enable, once we have more precise points-to
  // information
  Initialize({pathToLLFiles + "array/array_07_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleArrayTest_08) {
  Initialize({pathToLLFiles + "array/array_08_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleArrayTest_09) {
  Initialize({pathToLLFiles + "array/array_09_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({0}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleSTLArrayTest_01) {
  Initialize({pathToLLFiles + "array/stl_array/stl_array_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleSTLArrayTest_02) {
  Initialize({pathToLLFiles + "array/stl_array/stl_array_02_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({1}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleSTLArrayTest_03) {
  Initialize({pathToLLFiles + "array/stl_array/stl_array_03_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({2}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, DISABLED_HandleSTLArrayTest_04) {
  // Guaranteed to fail - enable, once we have more precise points-to
  // information
  Initialize({pathToLLFiles + "array/stl_array/stl_array_04_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleSTLArrayTest_05) {
  Initialize({pathToLLFiles + "array/stl_array/stl_array_05_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleSTLArrayTest_06) {
  Initialize({pathToLLFiles + "array/stl_array/stl_array_06_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({2}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, HandleCStringTest_01) {
  Initialize({pathToLLFiles + "array/cstring/cstring_01_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({}, llvmconstsolver);
...
TEST_F(IFDSConstAnalysisTest, DISABLED_HandleCStringTest_02) {
  // Guaranteed to fail - enable, once we have more precise points-to
  // information
  Initialize({pathToLLFiles + "array/cstring/cstring_02_cpp_m2r.ll"});
  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
      *constproblem, false);
  llvmconstsolver.solve();
  compareResults({2}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_01_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
...
//  Initialize({pathToLLFiles + "structs/structs_02_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0, 1, 5}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_03_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
...
//  Initialize({pathToLLFiles + "structs/structs_04_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
...
//  Initialize({pathToLLFiles + "structs/structs_05_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0, 1}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_06_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_07_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_08_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_09_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_10_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_11_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0}, llvmconstsolver);
...
//  Initialize({pathToLLFiles + "structs/structs_12_cpp.ll"});
//  LLVMIFDSSolver<const llvm::Value *, LLVMBasedICFG &> llvmconstsolver(
//      *constproblem, false);
//  llvmconstsolver.solve();
//  compareResults({0}, llvmconstsolver);
