...
TEST(DBTHTest, BasicTHReconstruction_1) {
  ...
  EXPECT_EQ(
      DBTH.isSubType(DBTH.getType("struct.Base"), DBTH.getType("struct.Child")),
      true);
  EXPECT_EQ(DBTH.isSuperType(DBTH.getType("struct.Child"),
                             DBTH.getType("struct.Base")),
            true);
  EXPECT_EQ(DBTH.hasVFTable(DBTH.getType("struct.Base")), true);
  EXPECT_EQ(DBTH.hasVFTable(DBTH.getType("struct.Child")), true);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Base"))
                ->getFunction(0)
                ->getName()
                .str(),
            "_ZN4Base3fooEv");
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))
                ->getFunction(0)
                ->getName()
                .str(),
            "_ZN5Child3fooEv");
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Base"))->size(), 1U);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))->size(), 1U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Base")).size(), 2U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Child")).size(), 1U);
  auto BaseReachable = DBTH.getSubTypes(DBTH.getType("struct.Base"));
  EXPECT_EQ(BaseReachable.count(DBTH.getType("struct.Base")), true);
  EXPECT_EQ(BaseReachable.count(DBTH.getType("struct.Child")), true);
  auto ChildReachable = DBTH.getSubTypes(DBTH.getType("struct.Child"));
  EXPECT_EQ(ChildReachable.count(DBTH.getType("struct.Child")), true);
}
...
TEST(DBTHTest, BasicTHReconstruction_3) {
  ...
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))
                ...
                .str(),
            "_ZN4Base3barEv");
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Base"))->size(), 2U);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))->size(), 2U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Base")).size(), 2U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Child")).size(), 1U);
  auto BaseReachable = DBTH.getSubTypes(DBTH.getType("struct.Base"));
  EXPECT_EQ(BaseReachable.count(DBTH.getType("struct.Base")), true);
...
TEST(DBTHTest, BasicTHReconstruction_4) {
  ...
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))
            ...
            "_ZN5Child3tarEv");
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Base"))->size(), 2U);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))->size(), 3U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Base")).size(), 2U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Child")).size(), 1U);
  auto BaseReachable = DBTH.getSubTypes(DBTH.getType("struct.Base"));
  EXPECT_EQ(BaseReachable.count(DBTH.getType("struct.Base")), true);
...
TEST(DBTHTest, BasicTHReconstruction_5) {
  ...
  EXPECT_EQ(DBTH.hasType(DBTH.getType("struct.Base")), true);
  EXPECT_EQ(DBTH.hasType(DBTH.getType("struct.Child")), true);
  EXPECT_EQ(DBTH.hasType(DBTH.getType("struct.OtherBase")), true);
  EXPECT_EQ(DBTH.getAllTypes().size(), 3U);
  EXPECT_EQ(
      DBTH.isSubType(DBTH.getType("struct.Base"), DBTH.getType("struct.Child")),
      true);
  EXPECT_EQ(DBTH.isSubType(DBTH.getType("struct.OtherBase"),
                           DBTH.getType("struct.Child")),
            true);
  EXPECT_EQ(DBTH.isSuperType(DBTH.getType("struct.Child"),
                             DBTH.getType("struct.Base")),
            true);
  EXPECT_EQ(DBTH.isSuperType(DBTH.getType("struct.Child"),
                             DBTH.getType("struct.OtherBase")),
            true);
  EXPECT_EQ(DBTH.hasVFTable(DBTH.getType("struct.Base")), true);
  EXPECT_EQ(DBTH.hasVFTable(DBTH.getType("struct.OtherBase")), true);
  EXPECT_EQ(DBTH.hasVFTable(DBTH.getType("struct.Child")), true);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Base"))
                ->getFunction(0)
                ->getName()
  ...
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Base"))
                ...
                .str(),
            "_ZN4Base3barEv");
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.OtherBase"))
                ->getFunction(0)
                ->getName()
                .str(),
            "_ZN9OtherBase3bazEv");
  ...
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Base"))->size(), 2U);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.OtherBase"))->size(), 1U);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))->size(), 5U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Base")).size(), 2U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.OtherBase")).size(), 2U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Child")).size(), 1U);
  auto BaseReachable = DBTH.getSubTypes(DBTH.getType("struct.Base"));
  EXPECT_EQ(BaseReachable.count(DBTH.getType("struct.Base")), true);
  EXPECT_EQ(BaseReachable.count(DBTH.getType("struct.Child")), true);
  auto OtherBaseReachable = DBTH.getSubTypes(DBTH.getType("struct.OtherBase"));
  EXPECT_EQ(OtherBaseReachable.count(DBTH.getType("struct.OtherBase")), true);
  EXPECT_EQ(OtherBaseReachable.count(DBTH.getType("struct.Child")), true);
  auto ChildReachable = DBTH.getSubTypes(DBTH.getType("struct.Child"));
  EXPECT_EQ(ChildReachable.count(DBTH.getType("struct.Child")), true);
}
...
TEST(DBTHTest, BasicTHReconstruction_6) {
  ...
  DIBasedTypeHierarchy DBTH(IRDB);
  EXPECT_EQ(DBTH.hasType(DBTH.getType("class.Base")), true);
  EXPECT_EQ(DBTH.hasType(DBTH.getType("struct.Child")), true);
  EXPECT_EQ(DBTH.getAllTypes().size(), 2U);
  EXPECT_EQ(
      DBTH.isSubType(DBTH.getType("class.Base"), DBTH.getType("struct.Child")),
      true);
  EXPECT_EQ(DBTH.isSuperType(DBTH.getType("struct.Child"),
                             DBTH.getType("class.Base")),
            true);
  EXPECT_EQ(DBTH.hasVFTable(DBTH.getType("class.Base")), true);
  EXPECT_EQ(DBTH.hasVFTable(DBTH.getType("struct.Child")), true);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("class.Base"))
                ->getFunction(0)
                ->getName()
                .str(),
            "_ZN4Base3fooEv");
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))
                ...
                .str(),
            "_ZN5Child3fooEv");
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("class.Base"))->size(), 1U);
  EXPECT_EQ(DBTH.getVFTable(DBTH.getType("struct.Child"))->size(), 1U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("class.Base")).size(), 2U);
  EXPECT_EQ(DBTH.getSubTypes(DBTH.getType("struct.Child")).size(), 1U);
  auto BaseReachable = DBTH.getSubTypes(DBTH.getType("class.Base"));
  EXPECT_EQ(BaseReachable.count(DBTH.getType("class.Base")), true);
  EXPECT_EQ(BaseReachable.count(DBTH.getType("struct.Child")), true);
  auto ChildReachable = DBTH.getSubTypes(DBTH.getType("struct.Child"));
  EXPECT_EQ(ChildReachable.count(DBTH.getType("struct.Child")), true);
}
...
TEST(DBTHTest, VTableConstruction) {
  ...
  ASSERT_TRUE(demangle(TH2.getVFTable(TH2.getType("struct.A"))
                           ->getFunction(0)
                           ->getName()
                           .str()) == "A::f()");
  ASSERT_TRUE(TH2.getVFTable(TH2.getType("struct.A"))->size() == 1U);
  ASSERT_TRUE(demangle(TH2.getVFTable(TH2.getType("struct.B"))
                           ->getFunction(0)
                           ->getName()
                           .str()) == "A::f()");
  ASSERT_TRUE(TH2.getVFTable(TH2.getType("struct.B"))->size() == 1U);
  ASSERT_TRUE(demangle(TH2.getVFTable(TH2.getType("struct.C"))
                           ->getFunction(0)
                           ->getName()
                           .str()) == "A::f()");
  ASSERT_TRUE(
  ...
  ASSERT_TRUE(demangle(TH2.getVFTable(TH2.getType("struct.D"))
                           ->getFunction(0)
                           ->getName()
                           .str()) == "A::f()");
  ASSERT_TRUE(TH2.getVFTable(TH2.getType("struct.D"))->size() == 1U);
  ASSERT_TRUE(demangle(TH2.getVFTable(TH2.getType("struct.X"))
                           ->getFunction(0)
                           ->getName()
                           .str()) == "X::g()");
  ASSERT_TRUE(
  ...
  ASSERT_TRUE(demangle(TH2.getVFTable(TH2.getType("struct.Y"))
                           ->getFunction(0)
                           ->getName()
                           .str()) == "X::g()");
  ASSERT_TRUE(
  ...
  ASSERT_TRUE(demangle(TH2.getVFTable(TH2.getType("struct.Z"))
                           ->getFunction(0)
                           ->getName()
                           .str()) == "A::f()");
  ASSERT_TRUE(demangle(TH2.getVFTable(TH2.getType("struct.Z"))
...
// TEST(DBTHTest, HandleLoadAndPrintOfNonEmptyGraph) {
//   LLVMProjectIRDB IRDB(
//       {pathToLLFiles + "type_hierarchies/type_hierarchy_1_cpp.ll"});
//   DIBasedTypeHierarchy TH(IRDB);
//   TH.print(llvm::outs());
//   //   std::ostringstream oss;
//   //   // Write empty DBTH graph as dot to string
//   //   TH.printGraphAsDot(oss);
//   //   oss.flush();
//   //   llvm::outs() << oss.str() << std::endl;
//   //   std::string dot = oss.str();
//   //   // Reconstruct a DBTH graph from the created dot file
//   //   std::istringstream iss(dot);
//   //   DIBasedTypeHierarchy::bidigraph_t G =
//   //   DIBasedTypeHierarchy::loadGraphFormDot(iss); boost::dynamic_properties
//   dp;
//   //   dp.property("node_id",
//   get(&DIBasedTypeHierarchy::VertexProperties::name,
...
// // TEST(DBTHTest, HandleLoadAndPrintOfEmptyGraph) {
// //   LLVMProjectIRDB IRDB({pathToLLFiles +
// //   "taint_analysis/growing_example_cpp.ll"}); DIBasedTypeHierarchy
// TH(IRDB);
// //   std::ostringstream oss;
// //   // Write empty DBTH graph as dot to string
// //   TH.printGraphAsDot(oss);
...
// dp;
// //   dp.property("node_id",
// get(&DIBasedTypeHierarchy::VertexProperties::name, G));
...
// // TEST(DBTHTest, HandleMerge_1) {
// //   LLVMProjectIRDB IRDB(
// //       {pathToLLFiles + "type_hierarchies/type_hierarchy_12_cpp.ll",
// //        pathToLLFiles + "type_hierarchies/type_hierarchy_12_b_cpp.ll"});
// //   DIBasedTypeHierarchy TH1(*IRDB.getModule(
// //       pathToLLFiles + "type_hierarchies/type_hierarchy_12_cpp.ll"));
// //   DIBasedTypeHierarchy TH2(*IRDB.getModule(
// //       pathToLLFiles + "type_hierarchies/type_hierarchy_12_b_cpp.ll"));
// //   TH1.mergeWith(TH2);
// //   TH1.print();
// //   EXPECT_TRUE(TH1.hasType(DBTH.getType("class.Base")));
// //   EXPECT_TRUE(TH1.hasType(DBTH.getType("struct.Child")));
// //   EXPECT_TRUE(TH1.hasType("struct.ChildsChild"));
// //   EXPECT_EQ(TH1.getNumTypes(), 3);
// //   EXPECT_TRUE(
// //       TH1.isSubType(DBTH.getType("class.Base"),
// DBTH.getType("struct.Child")));
// //   EXPECT_TRUE(TH1.isSubType(DBTH.getType("class.Base"),
// //   "struct.ChildsChild"));
// //   EXPECT_TRUE(TH1.isSubType(DBTH.getType("struct.Child"),
// //   "struct.ChildsChild")); EXPECT_TRUE(
// //       TH1.isSuperType(DBTH.getType("struct.Child"),
// //       DBTH.getType("class.Base")));
// //   EXPECT_TRUE(
// //       TH1.isSuperType("struct.ChildsChild",
// DBTH.getType("struct.Child")));
// //   EXPECT_TRUE(TH1.isSuperType("struct.ChildsChild",
// //   DBTH.getType("class.Base")));
// //   EXPECT_TRUE(TH1.hasVFTable(DBTH.getType("class.Base")));
// //   EXPECT_TRUE(TH1.hasVFTable(DBTH.getType("struct.Child")));
// //   EXPECT_TRUE(TH1.hasVFTable("struct.ChildsChild"));
// //   EXPECT_EQ(TH1.getVTableEntry(DBTH.getType("class.Base"), 0),
// //   "_ZN4Base3fooEv");
// //   EXPECT_EQ(TH1.getVTableEntry(DBTH.getType("struct.Child"), 0),
// //             "_ZN5Child3fooEv");
// //   EXPECT_EQ(TH1.getVTableEntry("struct.ChildsChild", 0),
// //             "_ZN11ChildsChild3fooEv");
// //   EXPECT_EQ(TH1.getNumVTableEntries(DBTH.getType("class.Base")), 1);
// //   EXPECT_EQ(TH1.getNumVTableEntries(DBTH.getType("struct.Child")), 1);
// //   EXPECT_EQ(TH1.getNumVTableEntries("struct.ChildsChild"), 1);
// //   EXPECT_EQ(TH1.getReachableSuperTypes(DBTH.getType("class.Base")).size(),
// 3U);
// // EXPECT_EQ(TH1.getReachableSuperTypes(DBTH.getType("struct.Child")).size(),
// //   2U); EXPECT_EQ(TH1.getReachableSuperTypes("struct.ChildsChild").size(),
// 1U);
// //   auto BaseReachable =
// TH1.getReachableSuperTypes(DBTH.getType("class.Base"));
// //   EXPECT_TRUE(BaseReachable.count(DBTH.getType("class.Base")));
// //   EXPECT_TRUE(BaseReachable.count(DBTH.getType("struct.Child")));
// //   EXPECT_TRUE(BaseReachable.count("struct.ChildsChild"));
// //   auto ChildReachable =
// //   TH1.getReachableSuperTypes(DBTH.getType("struct.Child"));
// //   EXPECT_TRUE(ChildReachable.count(DBTH.getType("struct.Child")));
