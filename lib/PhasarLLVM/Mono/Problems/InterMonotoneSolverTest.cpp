...
Domain_t InterMonotoneSolverTest::join(const Domain_t &Lhs,
                                       const Domain_t &Rhs) {
...
bool InterMonotoneSolverTest::sqSubSetEqual(const Domain_t &Lhs,
                                            const Domain_t &Rhs) {
...
Domain_t InterMonotoneSolverTest::normalFlow(const Node_t Stmt,
                                             const Domain_t &In) {
...
Domain_t InterMonotoneSolverTest::callFlow(const Node_t CallSite,
...
Domain_t InterMonotoneSolverTest::returnFlow(const Node_t CallSite,
                                             const Method_t Callee,
...
Domain_t InterMonotoneSolverTest::callToRetFlow(const Node_t CallSite,
                                                const Node_t RetSite,
                                                const Domain_t &In) {
...
MonoMap<Node_t, Domain_t> InterMonotoneSolverTest::initialSeeds() {
...
bool InterMonotoneSolverTest::recompute(const Method_t Callee) { return false; }
