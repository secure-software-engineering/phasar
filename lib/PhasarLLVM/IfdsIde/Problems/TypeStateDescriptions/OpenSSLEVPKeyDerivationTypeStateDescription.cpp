...
#include <phasar/PhasarLLVM/IfdsIde/Problems/TypeStateDescriptions/OpenSSLEVPKeyDerivationTypeStateDescription.h>
...
// Token: EVP_KDF_FETCH = 0, EVP_KDF_CTX_NEW = 1, EVP_KDF_CTX_SET_PARAMS = 2, DERIVE = 3, EVP_KDF_CTX_FREE = 4, STAR = 5 
// States: UNINIT = 0, KDF_FETCHED = 1, CTX_ATTACHED = 2, PARAM_INIT = 3, DERIVED = 4, ERROR = 5, BOT = 6
const OpenSSLEVPKeyDerivationTypeStateDescription::OpenSSLEVPKeyDerivationState
    OpenSSLEVPKeyDerivationTypeStateDescription::delta[6][7] = {
        /* EVP_KDF_FETCH */
        {OpenSSLEVPKeyDerivationState::KDF_FETCHED, OpenSSLEVPKeyDerivationState::KDF_FETCHED,
         OpenSSLEVPKeyDerivationState::CTX_ATTACHED, OpenSSLEVPKeyDerivationState::CTX_ATTACHED, OpenSSLEVPKeyDerivationState::CTX_ATTACHED,
         OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::BOT},
        /* EVP_KDF_CTX_NEW */
        {OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::CTX_ATTACHED,
         OpenSSLEVPKeyDerivationState::CTX_ATTACHED, OpenSSLEVPKeyDerivationState::CTX_ATTACHED, OpenSSLEVPKeyDerivationState::CTX_ATTACHED,
         OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::BOT},
        /* EVP_KDF_CTX_SET_PARAMS */
        {OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::ERROR,
         OpenSSLEVPKeyDerivationState::PARAM_INIT, OpenSSLEVPKeyDerivationState::PARAM_INIT, OpenSSLEVPKeyDerivationState::PARAM_INIT,
         OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::BOT},
         /* DERIVE */
        {OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::ERROR,
         OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::DERIVED, OpenSSLEVPKeyDerivationState::DERIVED,
         OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::BOT},
         /* EVP_KDF_CTX_FREE */
        {OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::ERROR,
         OpenSSLEVPKeyDerivationState::UNINIT, OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::BOT,
         OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::BOT},
         /* STAR */
        {OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::ERROR,
         OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::PARAM_INIT, OpenSSLEVPKeyDerivationState::DERIVED,
         OpenSSLEVPKeyDerivationState::ERROR, OpenSSLEVPKeyDerivationState::BOT},
};
...
bool OpenSSLEVPKeyDerivationTypeStateDescription::isFactoryFunction(
  ...
  if (isAPIFunction(F)) {
    return OpenSSLEVPKeyDerivationFuncs.at(F).find(-1) != OpenSSLEVPKeyDerivationFuncs.at(F).end();
  }
  return false;
}
...
bool OpenSSLEVPKeyDerivationTypeStateDescription::isAPIFunction(const std::string &F) const {
  return OpenSSLEVPKeyDerivationFuncs.find(F) != OpenSSLEVPKeyDerivationFuncs.end();
}

TypeStateDescription::State OpenSSLEVPKeyDerivationTypeStateDescription::getNextState(
    std::string Tok, TypeStateDescription::State S) const {
  if (isAPIFunction(Tok)) {
    return delta[static_cast<std::underlying_type_t<OpenSSLEVPKeyDerivationToken>>(
...
std::string OpenSSLEVPKeyDerivationTypeStateDescription::getTypeNameOfInterest() const {
...
set<int>
OpenSSLEVPKeyDerivationTypeStateDescription::getFactoryParamIdx(const std::string &F) const {
...
TypeStateDescription::State OpenSSLEVPKeyDerivationTypeStateDescription::bottom() const {
  return OpenSSLEVPKeyDerivationState::BOT;
}

TypeStateDescription::State OpenSSLEVPKeyDerivationTypeStateDescription::top() const {
  return OpenSSLEVPKeyDerivationState::TOP;
}

TypeStateDescription::State OpenSSLEVPKeyDerivationTypeStateDescription::uninit() const {
  return OpenSSLEVPKeyDerivationState::UNINIT;
}

TypeStateDescription::State OpenSSLEVPKeyDerivationTypeStateDescription::start() const {
  return OpenSSLEVPKeyDerivationState::KDF_FETCHED;
}

TypeStateDescription::State OpenSSLEVPKeyDerivationTypeStateDescription::error() const {
  return OpenSSLEVPKeyDerivationState::ERROR;
}

OpenSSLEVPKeyDerivationTypeStateDescription::OpenSSLEVPKeyDerivationToken
OpenSSLEVPKeyDerivationTypeStateDescription::funcNameToToken(const std::string &F) const {
  if (F == "EVP_KDF_fetch")
