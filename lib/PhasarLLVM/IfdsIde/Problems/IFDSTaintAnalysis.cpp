...
IFDSTaintAnalysis::IFDSTaintAnalysis(i_t icfg,const LLVMTypeHierarchy &th, const ProjectIRDB &irdb, TaintSensitiveFunctions TSF,
                                     vector<string> EntryPoints)
    : LLVMDefaultIFDSTabulationProblem(icfg,th,irdb), SourceSinkFunctions(TSF),
