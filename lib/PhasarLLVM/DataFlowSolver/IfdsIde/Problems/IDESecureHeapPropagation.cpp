...
IDESecureHeapPropagation::getCallToRetFlowFunction(n_t CallSite, n_t RetSite,
  ...
  if (FName == initializerFn) {
    return new Gen<d_t>(SecureHeapFact::INITIALIZED,
                                      getZeroValue());
  }
  return Identity<d_t>::getInstance();
}
...
IDESecureHeapPropagation::allTopFunction() {
  static auto AT = new AllTop<IDESecureHeapPropagation::IDETabProblemType>(l_t::TOP);
  return AT;
}
...
bool IDESecureHeapPropagation::IdentityEdgeFunction::equal_to(
    IDESecureHeapPropagation::EdgeFunctionPtrType Other) const {
...
IDESecureHeapPropagation::IdentityEdgeFunction::composeWith(
    IDESecureHeapPropagation::EdgeFunctionPtrType SecondFunction) {
...
IDESecureHeapPropagation::SHPEdgeFn::joinWith(
    IDESecureHeapPropagation::EdgeFunctionPtrType OtherFunction) {
...
IDESecureHeapPropagation::SHPGenEdgeFn::getInstance(l_t Val) {
  static std::array<SHPGenEdgeFn*, 3> Cache = {nullptr, nullptr,
                                                               nullptr};
