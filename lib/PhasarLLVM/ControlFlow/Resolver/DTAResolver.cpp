...
DTAResolver::DTAResolver(ProjectIRDB &irdb, LLVMTypeHierarchy &ch) : CHAResolver(irdb, ch) {}

bool DTAResolver::heuristic_anti_contructor_this_type(const llvm::BitCastInst* bitcast) {
...
bool DTAResolver::heuristic_anti_contructor_vtable_pos(const llvm::BitCastInst* bitcast) {
