...
class LLVMCoreConan(ConanFile):
    ...
    default_options = {
        ...
        'targets': 'all',
        'exceptions': True,
        'rtti': True, # default off, conan on
        'threads': True,
        'lto': 'Off',
        'static_stdlib': False,
        'unwind_tables': True,
    ...
    def _configure_cmake(self):
        ...
        cmake.definitions['LLVM_ENABLE_PIC'] = \
            self.options.get_safe('fPIC', default=False) # default on
        ...
        cmake.definitions['LLVM_INCLUDE_TOOLS'] = self.options.shared # default on
        cmake.definitions['LLVM_INCLUDE_EXAMPLES'] = False # default on, conan off
        cmake.definitions['LLVM_INCLUDE_TESTS'] = False # default on, conan off
        cmake.definitions['LLVM_INCLUDE_BENCHMARKS'] = False # default on, conan off
        cmake.definitions['LLVM_APPEND_VC_REV'] = False # default on, conan off
        ...
        cmake.definitions['LLVM_ENABLE_ASSERTIONS'] = \
            self.settings.build_type == 'Debug' # defaul on, conan off
        ...
        cmake.definitions['LLVM_ENABLE_LIBPFM'] = False # default on, conan off
        ...
        cmake.definitions['LLVM_ENABLE_ZLIB'] = \
            self.options.get_safe('with_zlib', False) # default on
