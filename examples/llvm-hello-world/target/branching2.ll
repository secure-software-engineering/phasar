...
entry:
  ...
  store i32 100, ptr %b, align 4, !dbg !25
  %0 = load i32, ptr %argc.addr, align 4, !dbg !26
  %sub = sub nsw i32 %0, 1, !dbg !28
  %tobool = icmp ne i32 %sub, 0, !dbg !26
  br i1 %tobool, label %if.then, label %if.else, !dbg !29

if.then:                                          ; preds = %entry
  store i32 20, ptr %a, align 4, !dbg !30
  br label %if.end, !dbg !32

if.else:                                          ; preds = %entry
  store i32 30, ptr %a, align 4, !dbg !33
  store i32 300, ptr %b, align 4, !dbg !35
  br label %if.end
...
!1 = !DIFile(filename: "branching2.cpp", directory: "phasar/examples/llvm-hello-world/target", checksumkind: CSK_MD5, checksum: "b690af5943eccd7364b9a6fb57366d39")
...
!24 = !DILocalVariable(name: "b", scope: !10, file: !1, line: 3, type: !13)
!25 = !DILocation(line: 3, column: 7, scope: !10)
!26 = !DILocation(line: 4, column: 7, scope: !27)
!27 = distinct !DILexicalBlock(scope: !10, file: !1, line: 4, column: 7)
!28 = !DILocation(line: 4, column: 12, scope: !27)
!29 = !DILocation(line: 4, column: 7, scope: !10)
!30 = !DILocation(line: 5, column: 7, scope: !31)
!31 = distinct !DILexicalBlock(scope: !27, file: !1, line: 4, column: 17)
!32 = !DILocation(line: 6, column: 3, scope: !31)
!33 = !DILocation(line: 7, column: 7, scope: !34)
!34 = distinct !DILexicalBlock(scope: !27, file: !1, line: 6, column: 10)
!35 = !DILocation(line: 8, column: 7, scope: !34)
!36 = !DILocation(line: 10, column: 10, scope: !10)
!37 = !DILocation(line: 10, column: 14, scope: !10)
!38 = !DILocation(line: 10, column: 12, scope: !10)
