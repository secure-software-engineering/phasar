; ModuleID = 'summary_class_3.ll.pp'
source_filename = "summary_class_3.cpp"
...
$_ZN5Point4setXEi = comdat any

$_ZN5Point4setYEi = comdat any

$_ZN5Point4getXEv = comdat any

$_ZN5Point4getYEv = comdat any

$_ZN5Point8identityEi = comdat any

; Function Attrs: uwtable
define void @_Z11pseudo_userv() #0 {
  %1 = alloca %class.Point, align 4
  call void @_ZN5PointC2Eii(%class.Point* %1, i32 1, i32 2)
  call void @_ZN5Point4setXEi(%class.Point* %1, i32 13)
  call void @_ZN5Point4setYEi(%class.Point* %1, i32 42)
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN5Point4setXEi(%class.Point*, i32) #1 comdat align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN5Point4setYEi(%class.Point*, i32) #1 comdat align 2 {
  %3 = getelementptr inbounds %class.Point, %class.Point* %0, i32 0, i32 1
  store i32 %1, i32* %3, align 4
  ret void
}

; Function Attrs: uwtable
define linkonce_odr i32 @_ZN5Point4getXEv(%class.Point*) #0 comdat align 2 {
  %2 = getelementptr inbounds %class.Point, %class.Point* %0, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = call i32 @_ZN5Point8identityEi(%class.Point* %0, i32 %3)
  ret i32 %4
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32 @_ZN5Point8identityEi(%class.Point*, i32) #1 comdat align 2 {
  ret i32 %1
}
