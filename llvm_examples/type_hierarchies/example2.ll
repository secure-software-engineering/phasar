...
define linkonce_odr void @_ZN5ChildC2Ev(%struct.Child*) unnamed_addr #1 comdat align 2 {
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ([3 x i8*], [3 x i8*]* @_ZTV5Child, i32 0, i32 2) to i32 (...)**), i32 (...)*** %3, align 8
  ret void
}
...
define linkonce_odr void @_ZN4BaseC2Ev(%struct.Base*) unnamed_addr #1 comdat align 2 {
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ([3 x i8*], [3 x i8*]* @_ZTV4Base, i32 0, i32 2) to i32 (...)**), i32 (...)*** %2, align 8
  ret void
}
