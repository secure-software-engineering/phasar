; ModuleID = 'example6.cpp'
source_filename = "example6.cpp"
...
@_ZTV5Child = linkonce_odr unnamed_addr constant [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI5Child to i8*), i8* bitcast (i32 (%struct.Child*)* @_ZN5Child3fooEv to i8*), i8* bitcast (i32 (%struct.Base*)* @_ZN4Base3barEv to i8*), i8* bitcast (i32 (%struct.Child*)* @_ZN5Child3tarEv to i8*)], comdat, align 8
...
define linkonce_odr void @_ZN5ChildC2Ev(%struct.Child*) unnamed_addr #1 comdat align 2 {
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ([5 x i8*], [5 x i8*]* @_ZTV5Child, i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  ret void
}
