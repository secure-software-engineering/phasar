; ModuleID = 'operator_shift.cpp'
source_filename = "operator_shift.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_operator_shift.cpp, i8* null }]
...
define i32 @main() #3 {
  ...
  %2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0))
...
; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_operator_shift.cpp() #0 section ".text.startup" {
