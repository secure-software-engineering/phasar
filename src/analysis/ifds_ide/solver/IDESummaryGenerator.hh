...
#ifndef SRC_ANALYSIS_IFDS_IDE_IDESUMMARYGENERATOR_HH_
#define SRC_ANALYSIS_IFDS_IDE_IDESUMMARYGENERATOR_HH_
...
protected:
  ...
  public:
    IDESummaryGenerator(string Function, I Icfg, SummaryGenerationCTXStrategy Strategy)
