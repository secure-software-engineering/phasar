...
TEST_F(PAMMTest, HandleSetHisto) {
  PAMM &pamm = PAMM::getInstance();
  pamm.regSetHistogram("Test-Set");
  pamm.addToSetHistogram("Test-Set",13);
  pamm.addToSetHistogram("Test-Set",13);
  pamm.addToSetHistogram("Test-Set",13);
  pamm.addToSetHistogram("Test-Set",42);
  pamm.addToSetHistogram("Test-Set",42);
  pamm.addToSetHistogram("Test-Set",42);
  pamm.addToSetHistogram("Test-Set",42);
  pamm.addToSetHistogram("Test-Set",42);
  ...
  pamm.addToSetHistogram("Test-Set",42);
  pamm.addToSetHistogram("Test-Set",42);
  pamm.addToSetHistogram("Test-Set",1);
  pamm.addToSetHistogram("Test-Set",1);
  pamm.addToSetHistogram("Test-Set",1);
  pamm.addToSetHistogram("Test-Set",1);
  pamm.addToSetHistogram("Test-Set",1);
  pamm.addToSetHistogram("Test-Set",2);
  pamm.addToSetHistogram("Test-Set",2);
  pamm.addToSetHistogram("Test-Set",2);
  EXPECT_EQ(pamm.getSetHistoData("Test-Set", 13), 3);
  EXPECT_EQ(pamm.getSetHistoData("Test-Set", 42), 13);
  EXPECT_EQ(pamm.getSetHistoData("Test-Set", 1), 5);
  EXPECT_EQ(pamm.getSetHistoData("Test-Set", 2), 3);
}
...
TEST_F(PAMMTest, HandleJSONOutput) {
  ...
  pamm.addToSetHistogram("Test-Set",42);
  pamm.addToSetHistogram("Test-Set",42);
  pamm.addToSetHistogram("Test-Set",54);
  pamm.addToSetHistogram("Test-Set",54);
  pamm.addToSetHistogram("Test-Set",54);
  pamm.addToSetHistogram("Test-Set",42);
...
TEST_F(PAMMTest, PerformanceTimerBasic) {
  ...
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_3 - start_3);
  std::cout << "timer_3 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_4 - start_4);
  std::cout << "timer_4 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_5 - start_5);
  std::cout << "timer_5 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_6 - start_6);
  std::cout << "timer_6 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_7 - start_7);
  std::cout << "timer_7 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_8 - start_8);
  std::cout << "timer_8 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_9 - start_9);
  std::cout << "timer_9 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_10 - start_10);
  std::cout << "timer_10 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_11 - start_11);
  std::cout << "timer_11 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_12 - start_12);
  std::cout << "timer_12 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_13 - start_13);
  std::cout << "timer_13 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_14 - start_14);
  std::cout << "timer_14 : " << duration.count() << std::endl;
  duration = std::chrono::duration_cast<std::chrono::microseconds>(end_15 - start_15);
...
TEST_F(PAMMTest, PerformanceTimerPAMM) {
  ...
  pamm.printStoppedTimer<std::chrono::microseconds>();
}
