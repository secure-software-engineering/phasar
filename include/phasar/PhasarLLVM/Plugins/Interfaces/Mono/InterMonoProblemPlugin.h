...
extern std::unique_ptr<InterMonoProblemPlugin> makeInterMonoProblemPlugin(
    const ProjectIRDB *IRDB, const TypeHierarchy<InterMonoProblemPlugin::t_t, InterMonoProblemPlugin::f_t> *TH, const InterMonoProblemPlugin::i_t *ICF,
    const PointsToInfo<InterMonoProblemPlugin::v_t, InterMonoProblemPlugin::n_t> *PT, std::set<std::string> EntryPoints);

extern std::map<std::string,
                std::unique_ptr<InterMonoProblemPlugin> (*)(
                    const ProjectIRDB *IRDB, const TypeHierarchy<InterMonoProblemPlugin::t_t, InterMonoProblemPlugin::f_t> *TH,
                    const InterMonoProblemPlugin::i_t *ICF, const PointsToInfo<InterMonoProblemPlugin::v_t, InterMonoProblemPlugin::n_t> *PT,
                    std::set<std::string> EntryPoints)>
