...
class LLVMDefaultWPDSProblem
    : public DefaultWPDSProblem<const llvm::Instruction *, D,
...
public:
  LLVMDefaultWPDSProblem(I ICFG, const LLVMTypeHierarchy &TH,
                         const ProjectIRDB &IRDB, WPDSType WPDS,
                         SearchDirection Direction,
                         std::vector<const llvm::Instruction *> Stack = {},
                         bool Witnesses = false)
      : DefaultWPDSProblem<const llvm::Instruction *, D, const llvm::Function *,
                           V, I>(ICFG, WPDS, Direction, move(Stack), Witnesses),
        th(TH), irdb(IRDB) {}
