...
public:
  ...
  typedef boost::graph_traits<rev_graph_t>::out_edge_iterator
      rev_out_edge_iterator;
  typedef boost::graph_traits<rev_graph_t>::in_edge_iterator
      rev_in_edge_iterator;
...
public:
  ...
  void addLinkWithoutReversePropagation(const llvm::StructType *from,
  ...
  getTypes(const llvm::StructType *struct_type);
