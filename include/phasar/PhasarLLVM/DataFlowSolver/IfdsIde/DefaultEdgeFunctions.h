...
#ifndef PHASAR_PHASARLLVM_DATAFLOWSOLVER_IFDSIDE_DEFAULTEDGEFUNCTIONS_H
#define PHASAR_PHASARLLVM_DATAFLOWSOLVER_IFDSIDE_DEFAULTEDGEFUNCTIONS_H
...
template <typename ConcreteEF, typename L>
EdgeFunction<L>
...
/// JoinEdgeFunction).
template <typename ConcreteEF, typename L,
          typename JLattice = JoinLatticeTraits<L>, uint8_t N = 0>
...
#endif // PHASAR_PHASARLLVM_DATAFLOWSOLVER_IFDSIDE_DEFAULTEDGEFUNCTIONS_H
