...
public:
  ...
  EdgeFunctionPtrType getCallEdgeFunction(n_t callStmt,
                                                         d_t srcNode,
  ...
  struct SHPEdgeFn : public EdgeFunction<IDETabProblemType> {
  ...
  struct SHPEdgeFunctionComposer
      : public EdgeFunctionComposer<IDETabProblemType> {
