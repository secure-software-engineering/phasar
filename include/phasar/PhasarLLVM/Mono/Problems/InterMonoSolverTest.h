...
public:
  ...
  d_t callFlow(n_t CallSite, m_t Callee, const d_t &In) override;

  d_t returnFlow(n_t CallSite, m_t Callee, n_t RetSite, const d_t &In) override;

  d_t callToRetFlow(n_t CallSite, n_t RetSite, const d_t &In) override;
