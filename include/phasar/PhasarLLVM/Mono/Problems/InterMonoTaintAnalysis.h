...
public:
  ...
  MonoSet<d_t> callFlow(n_t CallSite, m_t Callee,
                    const MonoSet<d_t> &In) override;

  MonoSet<d_t> returnFlow(n_t CallSite, m_t Callee, n_t RetSite,
                      const MonoSet<d_t> &In) override;

  MonoSet<d_t> callToRetFlow(n_t CallSite, n_t RetSite,
                         const MonoSet<d_t> &In) override;
