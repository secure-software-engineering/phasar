...
#ifndef SRC_ANALYSIS_IFDS_IDE_PROBLEMS_IDE_SOLVER_TEST_IDESOLVERTEST_H_
#define SRC_ANALYSIS_IFDS_IDE_PROBLEMS_IDE_SOLVER_TEST_IDESOLVERTEST_H_
...
class IDESolverTest
 ...
 public:
  ...
  shared_ptr<EdgeFunction<const llvm::Value *>> getCallEdgeFunction(
      const llvm::Instruction *callStmt, const llvm::Value *srcNode,
  ...
  shared_ptr<EdgeFunction<const llvm::Value *>> getCallToReturnEdgeFunction(
      const llvm::Instruction *callSite, const llvm::Value *callNode,
      const llvm::Instruction *retSite,
      const llvm::Value *retSiteNode) override;

  shared_ptr<EdgeFunction<const llvm::Value *>> getSummaryEdgeFunction(
      const llvm::Instruction *callStmt, const llvm::Value *callNode,
      const llvm::Instruction *retSite,
      const llvm::Value *retSiteNode) override;
