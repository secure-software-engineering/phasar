...
//   using GlobalDtorTy = std::multimap<size_t, llvm::Function *,
//   std::greater<>>;
...
//   // Map indirect calls to the number of possible targets found for it.
//   Fixpoint
...
//   boost::graph_traits<bidigraph_t>::out_edge_iterator; using in_edge_iterator
//   = boost::graph_traits<bidigraph_t>::in_edge_iterator;
...
//   makeResolver(ProjectIRDB &IRDB, LLVMTypeHierarchy &TH, LLVMPointsToInfo
//   &PT);
...
//           {
//             auto *Fun =
//             llvm::dyn_cast<llvm::Function>(FunDesc->getOperand(1)); const
//             auto *Prio =
...
//   /**
//    * Why a multimap?  A given instruction might have multiple target
//    functions.
...
//                 const std::set<std::string> &EntryPoints = {},
//                 LLVMTypeHierarchy *TH = nullptr, LLVMPointsToInfo *PT =
//                 nullptr, Soundness S = Soundness::Soundy, bool IncludeGlobals
//                 = true);
...
//   /**
//    * \return all of the functions in the IRDB, this may include some not in
//    the
//    * callgraph
//    */
...
//    * order, so building it is fast since we can always add to the end.  We
//    get
...
//    * the corresponding Function.  This pulls data directly from the
//    callgraph.
//    *
