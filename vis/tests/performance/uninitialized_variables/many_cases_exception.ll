; ModuleID = 'many_cases_exception.cpp'
source_filename = "many_cases_exception.cpp"
...
define i32 @_Z10myfunctioni(i32) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %6 = call i8* @__cxa_allocate_exception(i64 16) #6
...
; <label>:8:                                      ; preds = %1
  call void @__cxa_throw(i8* %6, i8* bitcast (i8** @_ZTISt13runtime_error to i8*), i8* bitcast (void (%"class.std::runtime_error"*)* @_ZNSt13runtime_errorD1Ev to i8*)) #7
  unreachable
...
; <label>:9:                                      ; preds = %1
  ...
  call void @__cxa_free_exception(i8* %6) #6
  br label %15
                                                  ; No predecessors!
...
; <label>:21:                                     ; preds = %17
  ...
  %23 = call i32 @llvm.eh.typeid.for(i8* bitcast (i8** @_ZTISt13runtime_error to i8*)) #6
  %24 = icmp eq i32 %22, %23
  br i1 %24, label %25, label %41

; <label>:25:                                     ; preds = %21
  %26 = load i8*, i8** %9, align 8
  %27 = call i8* @__cxa_begin_catch(i8* %26) #6
  ...
  %34 = call i8* %33(%"class.std::runtime_error"* %29) #6
...
attributes #4 = { nounwind ssp uwtable "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="core2" "target-features"="+cx16,+fxsr,+mmx,+sse,+sse2,+sse3,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #5 = { norecurse ssp uwtable "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="core2" "target-features"="+cx16,+fxsr,+mmx,+sse,+sse2,+sse3,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
